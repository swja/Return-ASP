...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:TextBox ID="TextBox1" runat="server" Width="177px" placeholder="Solo 10 digitos sin (-)" ToolTip="Ingrese solo 10 digitos sin (-)"></asp:TextBox>
    </p>
    <p>
    ...
    <p>
         <asp:TextBox ID="TextBox4" runat="server" Width="177px" placeholder="Solo 10 digitos sin (-)" ToolTip='placeholder="Solo 10 digitos sin (-)"'></asp:TextBox>
    </p>
    <p>
